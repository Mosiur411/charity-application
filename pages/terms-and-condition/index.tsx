          ...
          <div className="row">
            <div className="col-lg-12" data-aos="fade-right">
              <div className="title-style-five mb-65 lg-mb-40">
                ...
                <h2 className="main-title fw-500 tx-dark">Terms and Conditions</h2>
              </div>
            </div>
          </div>
        </div>
        <div className="container">
          <div className="row">
            <div className="col-xl-12 col-lg-12 order-lg-1 mb-60 mt-60">
              <h3>Welcome to DESHBHAKT!</h3>
              <p className="text-content tx-dark">
                These terms and conditions outline the rules and regulations for the use of DESHBHAKT&apos;s Website, located at
                http://deshbhakt.org/.
              </p>
              <p className="text-content tx-dark">
                By accessing this website we assume you accept these terms and conditions. Do not continue to use DESHBHAKT if
              ...
              <h4>Cookies</h4>
              <p className="text-content tx-dark">
                We employ the use of cookies. By accessing DESHBHAKT, you agreed to use cookies in agreement with the
                DESHBHAKT's Privacy Policy.
              </p>
              <p className="text-content tx-dark">
              ...
              <h4>License</h4>
              <p className="text-content tx-dark">
                Unless otherwise stated, DESHBHAKT and/or its licensors own the intellectual property rights for all material on
                DESHBHAKT. All intellectual property rights are reserved. You may access this from DESHBHAKT for your own
                personal use subjected to restrictions set in these terms and conditions.
              </p>
              <p className="text-content tx-dark">You must not:</p>
              <ul>
                <li className="text-content tx-dark">Republish material from DESHBHAKT</li>
                <li className="text-content tx-dark">Sell, rent or sub-license material from DESHBHAKT</li>
                <li className="text-content tx-dark">Reproduce, duplicate or copy material from DESHBHAKT</li>
                <li className="text-content tx-dark">Redistribute content from DESHBHAKT</li>
              </ul>
              <p className="text-content tx-dark">
              ...
              <p className="text-content tx-dark">
                ...
                areas of the website. DESHBHAKT does not filter, edit, publish or review Comments prior to their presence on the
                website. Comments do not reflect the views and opinions of DESHBHAKT,its agents and/or affiliates. Comments
                reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
                applicable laws, DESHBHAKT shall not be liable for the Comments or for any liability, damages or expenses caused
                and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
              </p>
              <p className="text-content tx-dark">
                DESHBHAKT reserves the right to monitor all Comments and to remove any Comments which can be considered
                inappropriate, offensive or causes breach of these Terms and Conditions.
              </p>
              <p className="text-content tx-dark">You warrant and represent that:</p>
              <ul>
                <li className="text-content tx-dark">
              ...
              <p className="text-content tx-dark">
                You hereby grant DESHBHAKT a non-exclusive license to use, reproduce, edit and authorize others to use,
              ...
              <ul>
                <li className="text-content tx-dark">Government agencies;</li>
                <li className="text-content tx-dark">Search engines;</li>
                <li className="text-content tx-dark">News organizations;</li>
                <li className="text-content tx-dark">
              ...
              <ul>
                <li className="text-content tx-dark">commonly-known consumer and/or business information sources;</li>
                <li className="text-content tx-dark">dot.com community sites;</li>
                <li className="text-content tx-dark">associations or other groups representing charities;</li>
                <li className="text-content tx-dark">online directory distributors;</li>
                <li className="text-content tx-dark">internet portals;</li>
                <li className="text-content tx-dark">accounting, law and consulting firms; and</li>
                <li className="text-content tx-dark">educational institutions and trade associations.</li>
              </ul>
              <p className="text-content tx-dark">
                ...
                DESHBHAKT; and (d) the link is in the context of general resource information.
              </p>
              <p className="text-content tx-dark">
              ...
              <p className="text-content tx-dark">
                ...
                you must inform us by sending an e-mail to DESHBHAKT. Please include your name, your organization name, contact
              ...
              <p className="text-content tx-dark">Approved organizations may hyperlink to our Website as follows:</p>
              <ul>
                <li className="text-content tx-dark">By use of our corporate name; or</li>
                <li className="text-content tx-dark">By use of the uniform resource locator being linked to; or</li>
                <li className="text-content tx-dark">
              ...
              <p className="text-content tx-dark">
                No use of DESHBHAKT's logo or other artwork will be allowed for linking absent a trademark license agreement.
              </p>
              <h4>iFrames</h4>
              <p className="text-content tx-dark">
              ...
              <ul>
                <li className="text-content tx-dark">limit or exclude our or your liability for death or personal injury;</li>
                <li className="text-content tx-dark">

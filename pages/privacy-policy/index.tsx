          ...
          <div className="row">
            <div className="col-lg-12" data-aos="fade-right">
              <div className="title-style-five mb-65 lg-mb-40">
                ...
                <h2 className="main-title fw-500 tx-dark">Privacy Policy</h2>
              </div>
            </div>
          </div>
        </div>
        <div className="container">
          <div className="row">
            <div className="col-xl-12 col-lg-12 order-lg-1 mb-60 mt-60">
              <h3>Privacy Policy for DESHBHAKT</h3>
              <p className="text-content tx-dark">
                At DESHBHAKT, accessible from http://deshbhakt.org/, one of our main priorities is the privacy of our visitors.
                This Privacy Policy document contains types of information that is collected and recorded by DESHBHAKT and how
                we use it.
              </p>
              <p className="text-content tx-dark">
              ...
              <p className="text-content tx-dark">
                ...
                to the information that they shared and/or collect in DESHBHAKT. This policy is not applicable to any
              ...
              <p className="text-content tx-dark">We use the information we collect in various ways, including to:</p>
              <ul>
                <li className="text-content tx-dark">Provide, operate, and maintain our website</li>
                <li className="text-content tx-dark">Improve, personalize, and expand our website</li>
                <li className="text-content tx-dark">Understand and analyze how you use our website</li>
                <li className="text-content tx-dark">Develop new products, services, features, and functionality</li>
                ...
                <li className="text-content tx-dark">Send you emails</li>
                <li className="text-content tx-dark">Find and prevent fraud</li>
              </ul>
              <h4>Log Files</h4>
              <p className="text-content tx-dark">
                DESHBHAKT follows a standard procedure of using log files. These files log visitors when they visit websites.
              ...
              <p className="text-content tx-dark">
                You may consult this list to find the Privacy Policy for each of the advertising partners of DESHBHAKT.
              </p>
              <p className="text-content tx-dark">
                Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
                in their respective advertisements and links that appear on DESHBHAKT, which are sent directly to users'
              ...
              <p className="text-content tx-dark">
                Note that DESHBHAKT has no access to or control over these cookies that are used by third-party advertisers.
              </p>
              <h4>Third Party Privacy Policies</h4>
              <p className="text-content tx-dark">
                DESHBHAKT's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
              ...
              <p className="text-content tx-dark">
                DESHBHAKT does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
